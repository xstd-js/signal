...
import { type LinkableSignalOptions } from './traits/types/linkable-signal-options.js';
...
export class LinkableSignal<GValue> extends Transient implements LinkableSignalTrait<GValue> {
  ...
  constructor(initialValue: SignalValueOrError<GValue>, options?: LinkableSignalOptions<GValue>) {
    super();
